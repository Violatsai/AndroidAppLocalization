...
public class BlacklistWhitelist extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        radiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i)
            {
                ...
                editor.apply();
                setTitle((i==R.id.blacklistradiobutton)?getString(R.string.blacklist):getString(R.string.whitelist));
    ...
    protected void onResume()
    {
        ...
        setTitle((preferences.getInt("blacklistwhitelistradiogrouppref",R.id.blacklistradiobutton)==R.id.blacklistradiobutton)?getString(R.string.blacklist):getString(R.string.whitelist));
